...
print()
print("🌐 Opening browser to: http://localhost:5003/stocks")
print("💡 Navigate to 'Stock Analysis' from the top menu if the direct link doesn't work")
print()

# Try to open the browser
try:
    webbrowser.open('http://localhost:5003/stocks')
    print("✅ Browser opened successfully!")
except Exception as e:
    print(f"❌ Could not open browser automatically: {e}")
    print("📋 Please manually navigate to: http://localhost:5003/stocks")
...
print()
print("🔄 The application is running on http://localhost:5003")
