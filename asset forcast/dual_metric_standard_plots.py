#!/usr/bin/env python3
"""
Dual Metric Standard Forecast Plots
==================================
...
def create_mape_focused_plot(ticker, train_data, actual_2024, old_forecast, enhanced_forecast, forecast_dates):
    ...
    if not actual_2024.empty:
        ...
        if overlap_days > 0:
            ...
            mape_old = mape_new = mape_improvement = mape_improvement_pct = 0
    else:
        mape_old = mape_new = mape_improvement = mape_improvement_pct = 0
    ...
    # Save MAPE plot
    output_dir = Path('dual_metric_plots/mape_focused')
...
def create_rmse_focused_plot(ticker, train_data, actual_2024, old_forecast, enhanced_forecast, forecast_dates):
    ...
    if not actual_2024.empty:
        ...
        if overlap_days > 0:
            ...
            rmse_old = rmse_new = rmse_improvement = rmse_improvement_pct = 0
    else:
        rmse_old = rmse_new = rmse_improvement = rmse_improvement_pct = 0
    ...
    # Save RMSE plot
    output_dir = Path('dual_metric_plots/rmse_focused')
    output_dir.mkdir(parents=True, exist_ok=True)
...
def main():
    ...
    print("📊 DUAL METRIC STANDARD FORECAST PLOTS")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("📊 DUAL METRIC PLOTS GENERATION COMPLETE!")
    print("=" * 60)
    ...
    print(f"\n🎉 GENERATED PLOTS:")
    print(f"   📁 MAPE plots: dual_metric_plots/mape_focused/")
    print(f"   📁 RMSE plots: dual_metric_plots/rmse_focused/")
