...
def create_comprehensive_summary():
    ...
    # Option 1 plots (standard) - check multiple locations
    option1_plots = []
    option1_plots.extend(list(Path('.').glob('*_2024_vs_actual.png')))
    option1_plots.extend(list(Path('improved_forecast_plots_2024').glob('*_2024_vs_actual.png')))
    option1_plots.extend(list(Path('forecast_plots_2024').glob('*_2024_vs_actual.png')))
    ...
    for plot in option1_plots:
        ticker = plot.stem.replace('_2024_vs_actual', '').replace('_REAL', '')
