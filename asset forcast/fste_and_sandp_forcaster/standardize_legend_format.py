...
def main():
    ...
    print(f"   🔬 Performance comparison with MAPE")
    
    print(f"\n💡 Legend inconsistency problem SOLVED!")
    print("   All graphs now show the same legend format.")
