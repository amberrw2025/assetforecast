...
class ModelEvaluator:
    ...
    def compare_models(self, metric: str = 'mape') -> pd.DataFrame:
        """
        Compare models based on a specific metric.
        
        Args:
            metric (str): Metric to compare on (default: MAPE for better stock forecasting)
    ...
    def plot_comparison(self, metric: str = 'mape', save_path: Optional[str] = None) -> None:
        """
        Plot model comparison.
        
        Args:
            metric (str): Metric to plot (default: MAPE for better stock forecasting)
    ...
    def get_best_model(self, metric: str = 'mape') -> Tuple[str, float]:
        """
        Get the best performing model.
        
        Args:
            metric (str): Metric to optimize for (default: MAPE for better stock forecasting)
        ...
        best_model = None
        best_score = np.inf if metric not in ['r2', 'directional_accuracy'] else -np.inf
